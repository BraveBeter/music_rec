...
from app.schemas.interaction import InteractionCreate, PlayHistoryResponse
from app.services.interaction_service import log_interaction, get_play_history
...
async def play_history(
    ...
    from app.schemas.interaction import PlayHistoryItem
