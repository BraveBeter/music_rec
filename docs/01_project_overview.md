...
**MusicRec** 是一个基于深度学习的个性化音乐推荐系统，融合 ItemCF 协同过滤、SASRec 序列模型、DeepFM 排序模型等多种推荐策略，提供从用户注册、音乐浏览试听、行为采集到实时个性化推荐的完整闭环体验。
...
| FastAPI Backend | 8000 | 18000 | 避免与本地 8000 冲突 |
| Vue Frontend (dev) | 3000 | 13000 | 避免与本地 3000 冲突 |
